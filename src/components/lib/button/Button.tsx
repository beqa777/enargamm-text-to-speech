import { AnchorHTMLAttributes, ButtonHTMLAttributes, cloneElement, CSSProperties, FC, forwardRef, LegacyRef, MouseEvent, MouseEventHandler, SVGProps, useMemo } from 'react';
...
interface ButtonBaseProps extends ButtonHTMLAttributes<HTMLButtonElement> {
    padding: number[],
    theme: 'white' | 'black' | 'blue' | 'gray' | 'drop',
...
export type ButtonProps = ButtonBaseProps &
    (
        | (Omit<JSX.IntrinsicElements["a"], "href"> & { href: AnchorHTMLAttributes<HTMLAnchorElement>["href"]; })
        | (& { href?: never; })
    );
